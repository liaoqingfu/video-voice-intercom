...
namespace XmlRpc {
  ...
  public:
    ...
    XmlRpcValue(long long value)  : _type(TypeLong) { _value.asLong = value; }
    ...
    XmlRpcValue& operator=(long long const& rhs) { return operator=(XmlRpcValue(rhs)); }
	...
	//for bsr API
    ValueStruct* getValueStruct() const { return _value.asStruct; }
    ...
    operator long long& ()   { assertTypeOrInvalid(TypeLong); return _value.asLong; }
    ...
    XmlRpcValue& operator[](std::string const& k) { assertStruct(k); return (*_value.asStruct)[k]; }
    XmlRpcValue& operator[](const char* k) { std::string s(k); assertStruct(s); return (*_value.asStruct)[s]; }
  ...
  protected:
    ...
    void assertStruct(const std::string& s);
    std::string getStringType(Type t);

    // XML decoding
    bool boolFromXml(std::string const& valueXml, int* offset);
    bool intFromXml(std::string const& valueXml, int* offset);
    bool longFromXml(std::string const& valueXml, int* offset);
